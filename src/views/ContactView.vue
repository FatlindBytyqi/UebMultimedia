<template>
<section class="bg-white py-5 py-xl-8">
  <div class="container mb-5 mb-md-6">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6 text-center">
        <h3 class="fs-6 text-secondary mb-2 text-uppercase">Get in Touch</h3>
        <h2 class="display-5 mb-4 mb-md-5">We're always on the lookout for new Judokas.</h2>
  ...
  <div class="container">
    <div class="row gy-4 gy-lg-0 gx-lg-6 gx-xxl-8 align-items-xl-center">
      <div class="col-12 col-lg-6">
        <img class="img-fluid rounded" loading="lazy" src="../assets/akil.jpg" alt="">
      </div>
      <div class="col-12 col-lg-6">
